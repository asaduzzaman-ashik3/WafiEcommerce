...
const MOCK_PRODUCT: Product = {
  ...
  description:
    "Experience world-class audio with these premium wireless headphones. Featuring active noise cancellation, 40-hour battery life, and superior comfort for long listening sessions.",
        ...
        >
          <View className="flex-row justify-between items-start">
            <View className="flex-1">
              <Text
                className="text-[12px] uppercase font-bold tracking-widest"
            ...
            <TouchableOpacity
              className="w-10 h-10 rounded-full items-center justify-center shadow-sm border border-gray-100"
              style={{ backgroundColor: colors.surface }}
            >
          ...
          <View
            className="flex-row items-center justify-between mt-lg bg-gray-50 p-4 rounded-2xl"
          ...
          >
            ...
            <View className="flex-row items-center bg-white rounded-xl p-1 shadow-sm">
              ...
              <Text
                className="mx-4 text-base font-bold"
                style={{ color: colors.textPrimary }}
              >
                {String(quantity)}
              </Text>
          ...
          <View className="mt-xl">
            ...
            >
              {TABS.map((tab, index) => (
                ...
                >
                  <Text
                    className={`font-bold ${activeTab === index ? "" : "opacity-40"}`}
                    style={{
                      color:
                        activeTab === index
                          ? colors.primary
                ...
                <View className="gap-3">
                  {[
                    ...
                    <View
                      ...
                      style={{ borderBottomColor: colors.primary + "05" }}
                    >
                ...
                <View className="py-4">
                  <View className="flex-row items-center gap-4 mb-6">
                    ...
                    <View className="flex-1">
                      ...
                      <Text className="text-xs text-gray-500 mt-1">
                        Based on 2.4k verified purchases
                      </Text>
                    </View>
                  </View>
                  <View
                  ...
                  >
                    ...
                    <Text className="text-sm text-gray-600 italic">
                      "Amazing sound quality and very comfortable for long
                      hours!"
                    </Text>
                  </View>
                </View>
      ...
      >
        <View className="flex-row items-center justify-between">
          ...
          <View className="flex-row gap-2">
            <TouchableOpacity
              className="px-5 h-12 rounded-xl items-center justify-center flex-row gap-2"
            ...
            <TouchableOpacity
              className="px-6 h-12 rounded-xl items-center justify-center shadow-lg shadow-primary/30"
              style={{ backgroundColor: colors.primary }}
            >
